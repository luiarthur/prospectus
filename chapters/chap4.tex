...
% Properties:
%1
%Note that the mechanism for drawing new dishes is the same as that for the IBP. 
%So the expected total number of dishes drawn, which is the total number of 
